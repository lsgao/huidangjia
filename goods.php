...
if (!empty($_REQUEST['act']) && $_REQUEST['act'] == 'price')
{
    ...
    $json   = new JSON;
    $res    = array('err_msg' => '', 'result_final_price' => '', 'result_rank_final_price' => '', 'qty' => 1);
    ...
    else
    {
        ...
        $all_price  = get_final_price2($goods_id, $number, true, $attr_id);
        $res ['result_final_price'] = price_format($all_price['final_price'] * $number);
        if($all_price['rank_final_price'] > 0){
          $res ['result_rank_final_price'] = price_format($all_price['rank_final_price'] * $number);
        }
    }
