<div id="content" class="footer mr-t20">
  ...
  <p class="region">
    ...
    <?php endif; ?>  <?php echo $this->_var['copyright']; ?> </p>
  <div class="favLink region"> <a href="http://www.51huidangjia.com"> powered by ecmoban </a> </div>
</div>
...
<div class="global-nav   global-nav--current">
    <div class="global-nav__nav-wrap">
        ...
        <div class="global-nav__nav-item">
            <?php if ($_SESSION['user_rank'] == 2 || $_SESSION['user_rank'] == 3 || $_SESSION['user_rank'] == 4): ?><a href="flow.php?step=cart" class="global-nav__nav-link"><?php else: ?><a href="javascript:void(0)" onclick="alert('您的用户级别无法购买商品');" class="global-nav__nav-link"><?php endif; ?>
