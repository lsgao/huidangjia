    ...
    <section class="order_box padd1 radius10 goodsBuy "> 
      <table class="ectouch_table" width="100%" border="0" cellspacing="0" cellpadding="5">
        ...
        <tr>
          ...
          <td bgcolor="#ffffff" align="left"> <?php echo $this->_var['lang']['far_ext']['\$r[1]']; ?><br />
...
<footer class="toolbar">
  ...
  <?php if ($_SESSION['user_rank'] == 2 || $_SESSION['user_rank'] == 3 || $_SESSION['user_rank'] == 4): ?><a href="flow.php?step=checkout"><?php else: ?><a href="javascript:void(0)" onclick="alert('您的用户级别无法购买商品');"><?php endif; ?>结算(<em class="num" id="total_number"><?php echo $this->_var['total']['total_number']; ?></em>)</a>
</footer>
<?php else: ?>
<section class="wrap"  >
...
?>
    <section class="order_box padd1 radius10" style="padding-top:0;padding-bottom:0;">
      <div class="table_box2 table_box">
        <form style="padding:8px;" action="flow.php" method="post" name="theForm" id="theForm" onSubmit="return checkConsignee(this, <?php echo $this->_var['include_bonded_goods']; ?>)">
  ...
  <script>
    ...
    function checkout(frm) {
      <?php if ($this->_var['include_bonded_goods'] == 1): ?>
        if (Utils.isEmpty(<?php echo $this->_var['consignee']['identity_card']; ?>)) {
          alert('购买跨境保税商品，请填写身份证');
          return false;
        }
      <?php endif; ?>
      return checkOrderForm(frm);
    }
  </script>
  <div id="page">
    <header id="header">
  ...
  <div class="blank3"></div>
  <section class="wrap">
    <form action="flow.php" method="post" name="theForm" id="theForm" onSubmit="return checkout(this)">
    <script type="text/javascript">
        ...
        <div class="table_box table_box1">
          <dl>
            ...
            <dd class="w50 c999">
              ...
              <?php echo $this->_var['consignee']['mobile']; ?> <a href="flow.php?step=consignee&include_bonded_goods=<?php echo $this->_var['include_bonded_goods']; ?>" class="modify radius5"><?php echo $this->_var['lang']['modify']; ?></a>
            </dd>
          </dl>
          <dl>
            <dd class="w50 b_no" ><?php echo $this->_var['lang']['country_province']; ?> <?php echo htmlspecialchars($this->_var['consignee']['province_name']); ?> <?php echo htmlspecialchars($this->_var['consignee']['city_name']); ?> <?php echo htmlspecialchars($this->_var['consignee']['district_name']); ?></dd>
          </dl>
          <dl>
          ...
          <?php if ($this->_var['include_bonded_goods'] == 1): ?>
          <dl>
            <dd class="w50 b_no" >身份证 <?php echo htmlspecialchars($this->_var['consignee']['identity_card']); ?> </dd>
          </dl>
          <?php endif; ?>
          <dl>
            <dd class="w50 b_no" >邮政编码 <?php echo htmlspecialchars($this->_var['consignee']['zipcode']); ?> </dd>
          </dl>
        </div>
      </div>
    </section>
...
?>
        <p>
          ...
          <label for="shipping_<?php echo $this->_var['shipping']['shipping_id']; ?>"> <?php echo $this->_var['shipping']['shipping_name']; ?> [<?php echo $this->_var['shipping']['format_shipping_fee']; ?>]</label>
        </p>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        <!--
...
?>
       ...
       <div class="dl_box">
          <dl>
            ...
            <dd class="weiruan " bgcolor="#ffffff"><input name="surplus" type="text" class="inputBg" id="ECS_SURPLUS" size="10" value="<?php echo empty($this->_var['order']['surplus']) ? '0' : $this->_var['order']['surplus']; ?>" onblur="changeSurplus(this.value)" <?php if ($this->_var['disable_surplus']): ?>disabled="disabled"<?php endif; ?> /></dd>
          </dl>
        </div>
       <div class="dl_box">
          <dl>
        ...
        <div class="dl_box">
          <dl>
            <dd class="c333">留言备注</dd>
            <dd ><input placeholder="请输入订单备注" name="inv_payee" type="text"   size="20"  /> </dd>
          </dl>
          <dl>
            <dd class="c333"></dd>
            <dd ><a href="flow.php" class="modify radius5"><?php echo $this->_var['lang']['modify']; ?></a></dd>
          </dl>
        </div>	
...
?>
    ...
    <div class="blank3"></div>
    <?php if ($_SESSION['user_rank'] == 2 || $_SESSION['user_rank'] == 3 || $_SESSION['user_rank'] == 4): ?><input type="submit" name="submit" value="提交订单" class="c-btn3" /><?php else: ?><input type="button" name="submit" onclick="alert('您的用户级别无法购买商品');" value="提交订单" class="c-btn3" /<?php endif; ?>
