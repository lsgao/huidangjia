...
$_LANG['order_id'] = '订单号';
$_LANG['percentage_separate'] = '分成';
$_LANG['percentage_cancel'] = '取消';
$_LANG['percentage_rollback'] = '撤销';
$_LANG['log_info'] = '操作信息';
$_LANG['edit_ok'] = '操作成功';
...
$_LANG['order_stats'][6] = '部分分单';
$_LANG['pay_stats'][0] = '未付款';
$_LANG['pay_stats'][1] = '付款中';
$_LANG['pay_stats'][2] = '已付款';
$_LANG['shipping_stats'][0] = '未发货';
$_LANG['shipping_stats'][1] = '已发货';
$_LANG['shipping_stats'][2] = '已收货';
$_LANG['shipping_stats'][3] = '备货中';
$_LANG['shipping_stats'][4] = '已发货(部分商品)';
$_LANG['shipping_stats'][5] = '发货中(处理分单)';
$_LANG['shipping_stats'][6] = '已发货(部分商品)';
...
$_LANG['show_percentage_orders'] = '此列表显示此用户推荐的订单信息。';
